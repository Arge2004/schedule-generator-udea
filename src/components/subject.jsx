...
export default function Subject({materia}) {
  ...
  return (
    <label className={`flex items-center gap-3 p-2.5 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-900 cursor-pointer group transition-all border-2 ${isSelected ? 'border-primary' : 'border-transparent'}`}>
      <input
