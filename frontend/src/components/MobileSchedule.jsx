              ...
              {DIAS.map((dia, index) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 min-w-[60px] py-3 px-2 text-sm font-medium  relative
                                            ${
                                              activeDay === index
                                                ? "text-primary"
                                                : hasClasses
                  ...
                  >
                    <div className="flex flex-col items-center gap-1">
                      ...
                      {hasClasses && (
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${activeDay === index ? "bg-primary" : "bg-zinc-400"}`}
                        />
                      )}
                    </div>
                    {activeDay === index && (
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {getClassesByDay(activeDay).length === 0 ? (
                    ...
                    >
                      {/* Grid de horas */}
                      {Array.from({ length: 16 }, (_, i) => i + 6).map(
                        (hora, horaIdx) => (
