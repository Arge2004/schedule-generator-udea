                ...
                <div className="border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/50 backdrop-blur-sm px-6 py-3 flex-shrink-0 min-h-[60px]">
                    <div className="flex items-center justify-center h-full">
                        <div className="flex justify-center gap-4">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-zinc-600 dark:text-zinc-300 group-hover:text-amber-500 dark:group-hover:text-violet-400 transition-colors">
