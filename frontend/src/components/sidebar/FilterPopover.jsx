 ...
 * - Desktop: Protruding popover anchored to the right of the sidebar.
 * - Mobile: Centered modal with backdrop blur to fit on screen properly.
 */
...
export default function FilterPopover({
  ...
  // Modo Desktop: Popover sobresaliendo hacia la derecha
  return (
    <>
      <div
