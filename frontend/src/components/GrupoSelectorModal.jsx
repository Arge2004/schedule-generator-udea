...
export default function GrupoSelectorModal() {
  ...
  const { celdasMateria, showToastMessage, checkGrupoConflict } =
    useScheduleContext();
  const dias = [
    "Lunes",
    "Martes",
      ...
      >
              ...
              >
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div
                      className={`w-2 h-2 rounded-full ${sinCupos ? "bg-red-400" : "bg-emerald-400"}`}
                    />
        ...
        <div className="p-6 border-t border-zinc-200 dark:border-zinc-800 flex justify-end gap-3">
          <button
            ...
            className="px-5 py-2.5 rounded-lg text-sm font-semibold text-zinc-700 dark:text-zinc-300 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 "
          >
            Cancelar
          </button>
        </div>
